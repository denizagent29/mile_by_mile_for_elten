...
module MileByMile
  ...
  class Game
    ...
    def play_distance(player, card)
      car = player.car
      raise RuleViolation, 'машина не заведена или не на ходу' unless car.moving?
      raise RuleViolation, 'ограничение скорости: можно только 25 или 50 миль' if car.speed_limited? && card.miles > 50
      ...
      raise RuleViolation, 'нельзя проехать дальше финиша' if new_distance > distance_target
